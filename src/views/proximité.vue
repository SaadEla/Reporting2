        ...
        <v-card class="mb-12">
          ...
          <v-card-text>
            <v-form class="px-3" ref="form">
              ...
              <v-layout>
                <!-- Distance minimale du tampon (mètre) -->
                <v-flex sm2 md2>
                  <v-text-field
                    v-model="foo"
                    type="number"
                    label="Distance minimale du tampon (mètre)"
                    min="50"
                ...
                <v-flex sm1 md1></v-flex>
                <!-- Durée d'arrét minimale (min) -->
                <v-flex sm2 md2>
                  <v-text-field
                    v-model="foo1"
                    type="number"
                    min="0"
                    label="Durée d'arrét minimale (min)"
                    @click:append-outer="increment1"
                    @click:prepend="decrement1"
                  ></v-text-field>
                </v-flex>
                <v-flex sm1 md1></v-flex>
                <!-- selectionner -->
